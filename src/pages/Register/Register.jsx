      ...
      <div className="bg-[#A9DFBF]/10 backdrop-blur-md rounded-[36px] p-8 md:p-10 shadow-2xl border border-[#A9DFBF]/30 max-w-md w-full z-10 relative">
        ...
        >
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="w-full bg-slate-900 hover:bg-[#f2687c] disabled:bg-slate-400 text-white font-extrabold text-xs py-4 px-6 rounded-xl transition-all duration-300 shadow-md uppercase tracking-wider hover:scale-[1.02] active:scale-[0.98] mt-3 flex justify-center items-center gap-2"
          >
            {isLoading ? (
              <>
